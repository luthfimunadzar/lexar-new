<template>
  <div>
    ...
    <div
      class="inner-hero"
      style="
        background-image: url('/lexar/career-bg3.jpg');
        ...
        <b-row>
          <b-col md="12" class="text-center">
            ...
            <p class="intro">
              ...
              – Knowing who you are and how you want to be in this world, this
              is what makes work fun.
            </p>

            <p class="intro">
              We hire exceptional people and help them develop both personally
              and professionally. We help our team members to grow in their
              current roles and dream about what's next. We promise to help them
              complete the circle that maximize their potential and connect them
              with their next possibilities.
            </p>

            <p class="intro mb-5">
              Are you the one we've been looking for? Send your CV and portfolio
              to hello@lexar.id and be part of us!
            </p>
          </b-col>
          <!-- <b-col md="12">
    ...
    return {
      ...
      meta: [
        // hid is used as unique identifier. Do not use `vmid` for it as it will not work
        {
          hid: "description",
          name: "description",
          content: "We value you more than your job title",
        },
